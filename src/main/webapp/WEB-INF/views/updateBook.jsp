			...
			<div class="col-md-6 offset-md-3 mt-3">
				<div class="my-card">
					...
					<div class="container text-center">
						<img alt="updateBook-Logo" src="/images/updateBook.png"
							style="width: 80px">
					</div>
					...
					<form action="/editBook" method="post">
						...
						<!-- This is Book Id Field -->
						<div class="form-group">
							<label for="bookId">Book ID</label> <input type="number"
						...
						<div class="text-center">
							<button type="submit" class="btn btn-info">
								<i class="fas fa-plus-circle"></i>&nbsp; Edit BOOK
							</button>
						</div>
